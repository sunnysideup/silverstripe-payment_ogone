...
class OgonePayment extends Payment
{
    ...
    */
    ...
    public static function get_payment_options_array()
    {
        return self::$payment_options_array;
    }
    public static function set_payment_options_array($a)
    {
        self::$payment_options_array = $a;
    }
    public static function add_payment_option($key, $title)
    {
        self::$payment_options_array[$key] = $title;
    }
    public static function remove_payment_option($key)
    {
        unset(self::$payment_options_array[$key]);
    }
    ...
    */
    ...
    public static function set_logos_array($a)
    {
        self::$logos_array = $a;
    }
    public static function remove_payment_option_from_logos_array($paymentOption)
    {
        unset(self::$logos_array[$paymentOption]);
    }
    public static function add_payment_option_to_logos_array($paymentOption, $paymentOptionArray)
    {
        self::$logos_array[$paymentOption] = $paymentOptionArray;
    }
    public static function get_logos_array()
    {
        return self::$logos_array;
    }
    // Ogone Information

    protected static $privacy_link = 'http://www.ogone.com/en/About%20Ogone/Privacy%20Policy.aspx';
    public static function set_privacy_link($v)
    {
        self::$privacy_link = $v;
    }
    ...
    **/
    ...
    public static function set_account_pspid($account_pspid)
    {
        self::$account_pspid = $account_pspid;
    }

    protected static $sha_passphrase;
    public static function set_sha_passphrase($sha_passphrase)
    {
        self::$sha_passphrase = $sha_passphrase;
    }
    public static function get_sha_passphrase()
    {
        return self::$sha_passphrase;
    }

    // Ogone Pages Style Optional Informations

    protected static $page_title;
    public static function set_page_title($page_title)
    {
        self::$page_title = $page_title;
    }

    protected static $back_color;
    public static function set_back_color($back_color)
    {
        self::$back_color = $back_color;
    }

    protected static $text_color;
    public static function set_text_color($text_color)
    {
        self::$text_color = $text_color;
    }

    protected static $table_back_color;
    public static function set_table_back_color($table_back_color)
    {
        self::$table_back_color = $table_back_color;
    }

    protected static $table_text_color;
    public static function set_table_text_color($table_text_color)
    {
        self::$table_text_color = $table_text_color;
    }

    protected static $button_back_color;
    public static function set_button_back_color($button_back_color)
    {
        self::$button_back_color = $button_back_color;
    }

    protected static $button_text_color;
    public static function set_button_text_color($button_text_color)
    {
        self::$button_text_color = $button_text_color;
    }

    protected static $font_type;
    public static function set_font_type($font_type)
    {
    ...
    public static function set_template($v)
    {
        self::$template = $v;
    }

    protected static $hide_payment_method_in_orderform = true;
    public static function set_hide_payment_method_in_orderform($v)
    {
        self::$hide_payment_method_in_orderform = $v;
    }
    ...
    public function OgoneForm()
    {
        ...
        if ($member->hasMethod('getPhoneNumber')) {
            $inputs['OWNERTELNO'] = $member->getPhoneNumber();
        }
        $inputs['PMLISTTYPE'] = 2;
        ...
        if (self::$page_title) {
            $inputs['TITLE'] = self::$page_title;
        }
        if (self::$back_color) {
            $inputs['BGCOLOR'] = self::$back_color;
        }
        if (self::$text_color) {
            $inputs['TXTCOLOR'] = self::$text_color;
        }
        if (self::$table_back_color) {
            $inputs['TBLBGCOLOR'] = self::$table_back_color;
        }
        if (self::$table_text_color) {
            $inputs['TBLTXTCOLOR'] = self::$table_text_color;
        }
        if (self::$button_back_color) {
            $inputs['BUTTONBGCOLOR'] = self::$button_back_color;
        }
        if (self::$button_text_color) {
            $inputs['BUTTONTXTCOLOR'] = self::$button_text_color;
        }
        if (self::$font_type) {
            $inputs['FONTTYPE'] = self::$font_type;
        }
        if (self::$image_url) {
            $inputs['LOGO'] = urlencode(self::$image_url);
        }
...
class OgonePayment_Handler extends Controller
{
    ...
    public static function get_url_segment()
    {
        return self::$url_segment;
    }
    public static function set_url_segment($v)
    {
        self::$url_segment = $v;
    }

    public static function redirect_link($action, $order, $payment)
    {
    ...
    public function shaOutVariables()
    {
        return array(
